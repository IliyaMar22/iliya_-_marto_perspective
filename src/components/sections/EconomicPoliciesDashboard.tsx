...
const SectionNavigator: React.FC<{
  ...
  <div className="sticky top-0 z-10 bg-white shadow-md rounded-xl p-4 mb-8">
    <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3">Policy Sections</h3>
      ...
      {section.slides.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/90 rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 bg-white/90 rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
          >
            <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {section.slides.map((_, idx) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all ${
                idx === currentSlide ? 'bg-green-600 w-8' : 'bg-gray-300 hover:bg-gray-400'
              }`}
            />
          ))}
        </div>
...
const EconomicPoliciesDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-green-700 via-emerald-600 to-teal-600 rounded-2xl p-8 text-white">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 bg-white text-green-700 font-semibold rounded-xl hover:bg-green-50 transition-all shadow-lg hover:shadow-xl"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
                <span className="text-2xl font-bold text-green-700">{section.number || '🎯'}</span>
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-800">{section.title}</h2>
                {section.number && (
                  <p className="text-gray-500">Section {section.number}</p>
                )}
              </div>
            </div>
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/10 rounded-xl p-6">
            ...
            <h4 className="font-semibold text-lg mb-2">Short-Term (0-6 Months)</h4>
            <p className="text-white/80 text-sm">Quick wins: LTV adjustments, infrastructure fast-tracking, wage restraint</p>
          </div>
          <div className="bg-white/10 rounded-xl p-6">
            <div className="text-4xl mb-3">📅</div>
            <h4 className="font-semibold text-lg mb-2">Medium-Term (6-24 Months)</h4>
            <p className="text-white/80 text-sm">Fiscal reform, industrial clusters, R&D programs, admin reform</p>
          </div>
          <div className="bg-white/10 rounded-xl p-6">
            <div className="text-4xl mb-3">🎯</div>
            <h4 className="font-semibold text-lg mb-2">Long-Term (2-7 Years)</h4>
            <p className="text-white/80 text-sm">Education reform, capital markets, institutional reforms, regional development</p>
          </div>
        </div>
      </div>
